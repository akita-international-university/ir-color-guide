...
> [!NOTE]
> 教学IRチームが作成するすべての可視化資料を色覚多様性に対応したものにすることを目指しているものの、現時点で利用可能なリソースの制約により、既存の可視化資料の大部分を色覚多様性に完全に対応していないパレットから移行することが現実的であると判断しました。今後も可視化資料のアクセシビリティ向上に向けて継続的に取り組んでいきます。特に、色覚多様性対応の確保を自動化するためのご提案やフィードバックを歓迎いたします。
